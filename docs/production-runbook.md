...
image exists for controlled Coolify deployments and smoke tests; it must not be
treated as an independent production source of truth for the same domain.
